...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Update account information if save_info was checked
        account = None
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                ...
                account.default_street_address1 = shipping_details.address.line1  # noqa
                account.default_street_address2 = shipping_details.address.line2  # noqa
